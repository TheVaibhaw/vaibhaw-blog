...
/**
 * Search Results Template - Card Layout
 *
...
<div class="search-page">
    <div class="search-container">
        <header class="search-hero" data-animate="fade-up">
            <span class="search-hero__label">Search Results</span>
            <h1 class="search-hero__title">
                <?php printf(esc_html__('Results for: %s', 'generatepress'), '<span>' . get_search_query() . '</span>'); ?>
            </h1>
            <p class="search-hero__desc">
                <?php
                global $wp_query;
                $total = $wp_query->found_posts;
                printf(esc_html(_n('%d article found', '%d articles found', $total, 'generatepress')), $total);
                ?>
            </p>
